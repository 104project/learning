    ...
    <section class="content content-light  videos-list videos-list-grid">
        <div class="container">
            ...
            <div class="filter">
                    ...
                    <a href="/video/index" class="btn btn-newtheme btn-neworange">所有影片</a>
                @foreach($Videos_Category as $videocategory)
                    <a href="/video/index/{{ $videocategory->tag }}" class="btn btn-newtheme btn-newgreen">{{ $videocategory->tag }}</a>
                @endforeach
            </div>
